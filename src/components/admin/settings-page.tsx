...
const blocks = [
  ...
  },
  {
    ...
    items: [
      ...
      ['WhatsApp', 'Configurar CTA global quando o canal oficial estiver disponível'],
    ],
  },
  {
    ...
    icon: Wrench,
    items: [
      ['Editor de páginas', 'Ativo com rascunho e publicação'],
      ['Upload de imagens', 'Protegido para usuários autenticados'],
  ...
  },
  {
    ...
    icon: Shield,
    items: [
      ['Login admin', 'Protegido por credencial com hash em banco'],
      ['Sessão', 'Persistência por JWT com role na sessão'],
      ['Produção', 'Exige NEXTAUTH_SECRET e DATABASE_URL configurados'],
    ],
  },
]
...
export function SettingsPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-cormorant text-2xl font-light text-white lg:text-3xl">Configurações</h1>
